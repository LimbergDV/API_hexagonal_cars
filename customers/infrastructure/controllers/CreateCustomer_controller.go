...
import (
	"api-hexagonal-cars/customers/application"
	"api-hexagonal-cars/customers/domain"
	"api-hexagonal-cars/customers/infrastructure"
	"api-hexagonal-cars/customers/infrastructure/routes/validators"
	"net/http"
